...
public class Waypoint : MonoBehaviour
{
	...
	public void Click()
	{
        ...
        CameraEndPosition = gameObject.transform.position;
        StartCoroutine(CameraTravel(Duration));
    }
    ...
    private IEnumerator CameraTravel(float Duration)
    {
        ...
        do
        {
            ...
            //Camera travels to destination waypoint
            Camera.main.transform.position = Vector3.Lerp(CameraStartPosition, CameraEndPosition, percentage);
